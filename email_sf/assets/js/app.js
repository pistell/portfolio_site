	...
	$( document ).ready(function() {
		...
		$('#generate').click(function() {
	        ...
	        //Begin displaying Agent information
	      	...
	      	ctx.fillText(agentName, (canvas.width / 1.82) - (textWidth / 2), 80);
	      	ctx.font = "16px Helvetica";
	      	ctx.fillText("State Farm Insurance Agent", 280, 110);
	      	ctx.font = "30px Helvetica";
	      	//ctx.fillText("281-330-8004", 290, 160);
	      	ctx.fillText(siteURL, 290, 160);
	      	//The state farm logo     	
			var imageObj = new Image();
	  		imageObj.onload = function() {
	    		ctx.drawImage(imageObj, 545, 70, 140, 70);
	  		};
			...
			agentMug.onload = function(){
			    ctx.drawImage(agentMug, 20, 0, 190, 250);
