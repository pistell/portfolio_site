/**
 * @link https://github.com/pinceladasdaweb/imgur
 */
(function (root, factory) {
	...
	Imgur.prototype = {
		...
		createDragZone: function () {
			...
			p = this.createEls('p', {}, 'Drag your file here or click in this area. This image will immediately be uploaded to imgur.com upon selection.');
		...
		loading: function () {
			...
			img = this.createEls('img', {
				...
				src: './assets/img/loading-spin.svg'
			});
		...
		matchFiles: function (file, zone) {
			...
			if (file.type.match(/image/) && file.type !== 'image/svg+xml') {
				...
				status.innerHTML = 'Hmmm, something went wrong...';
			}
		},
